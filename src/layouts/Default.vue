    ...
    <header>
      <div class="container justify-left">
        <div class="d-flex justify-right">
          ...
          <nav class="nav justify-right">
             <g-link to="/About">resume </g-link>
            <a href>portfolio</a>
            <a href>contact</a>
          </nav>
        </div>
  ...
  <button ref="themeswitcher" class="icon-light" id="theme-switcher" @click="toggleTheme"></button>
    ...
    <footer>
      ...
      <div class="container">
        <div class="d-flex justify-right">
        <div class="site">
          rubenmarcus.dev <span class="copyleft">©</span> 2012-2020
        </div>
        <div class="contact-me"><a href="mailto:ruben@rubenmarcus.dev?Subject=Hello!">ruben@rubenmarcus.dev</a></div>

  <div class="justify-left align-top flex">
    
    <div class="icons-mid full-width justify-center d-flex">
